...
import { Plus, MessageSquare, Settings, LogOut, Globe, Users, QrCode, LayoutDashboard, Database } from 'lucide-react';
...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  const isDataSourcesActive = location.pathname === '/data-sources';
  const isChatActive = !isProfileActive && !isEcosystemActive && !isCommunityActive && !isDashboardActive && !isDataSourcesActive;
  const handleLogout = () => {
