...
import { EcosystemDataFormHeader, EcosystemDataFormContent } from '@/components/ecosystem/EcosystemDataForm';
...
import { CriticalPathDisplay } from '@/components/ecosystem/CriticalPathDisplay';
import { CriticalPathManager } from '@/components/ecosystem/CriticalPathManager';
export function EcosystemPage() {
  ...
  const activeCriticalPath = useMemo(() => {
    return store.criticalPaths.find(p => p.id === store.activeCriticalPathId) || null;
  }, [store.criticalPaths, store.activeCriticalPathId]);
  ...
  return (
    ...
    >
      <div className="flex-shrink-0">
        ...
        <p className="text-lg text-muted-foreground mt-1 text-balance">
          ...
          >
            <motion.div variants={cardVariants}>
              <Accordion type="multiple" defaultValue={[]} className="w-full space-y-6">
                <AccordionItem value="data-form" className="border-b-0 overflow-hidden rounded-lg border bg-card text-card-foreground shadow-sm">
                  <AccordionTrigger className="p-6">
                    <EcosystemDataFormHeader />
                  </AccordionTrigger>
                  <AccordionContent className="px-6 pb-6">
                    <EcosystemDataFormContent />
                  </AccordionContent>
                </AccordionItem>
                <AccordionItem value="relationship-manager" className="border-b-0 overflow-hidden rounded-lg border bg-card text-card-foreground shadow-sm">
                  <AccordionTrigger className="p-6">
